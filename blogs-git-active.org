...
2. git服务器假设方案:
| HTTP | Git-daemon | SSH | Gitoslite |   |
|------+------------+-----+-----------+---|
|      |            |     |           |   |
   1. HTTP: 简单,支持匿名读取,支持身份认证,支持版本库写操作,不支持企业级授权,不支持远程建库
   2. Git-daemon: 中等难度,支持匿名读取,不支持身份认证,不支持版本库写操作,不支持企业级授权,不支持远程建库
   3. SSH:  简单,不支持匿名读取,支持身份认证,支持版本库写操作,不支持企业级授权,不支持远程建库
   4. Gitoslite: 复杂,不支持匿名读取,支持身份认证,支持版本库写操作,支持企业级授权,支持远程建库
3. HTTP
