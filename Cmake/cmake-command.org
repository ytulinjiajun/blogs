...
*** <<get_property>> :Scripting Commands:
asd
*** <<set_property>> :Scripting Commands:
*** <<get_cmake_property>> :Scripting Commands:
*** <<get_directory_property>> :Scripting Commands:
*** <<set_directory_properties>> :Scripting Commands:
...
*** <<define_property>> :Project Commands:
*** <<get_source_file_property>> :Project Commands:
*** <<set_source_files_properties>> :Project Commands:
#+BEGIN_SRC 
...
#+END_SRC
*** <<get_target_property>> :Project Commands:
*** <<set_target_properties>> :Project Commands:
*** <<get_test_property>> :Project Commands:
*** <<set_tests_properties>> :Project Commands:
** CTest Commands
** Deprecated Commands
