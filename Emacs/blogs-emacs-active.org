...
** WAITTING [#C] Theme: FAQ
*** YCM-Generator/fake-toolchain/Unix/clang" is not able to compile a simple test program :@YCM:Generator:
...
*** ERROR: No Commands were logged to the build logs,. Your build system may not be compatible :@YCM:Generator:
