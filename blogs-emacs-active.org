...
** WAITTING Theme:evil-mode								   :@Blog:@Emacs:
...
21. 拷贝： y
22. 剪切字符： x
23. 选区：在normal-mode下按v或者V
24. 删除选区之间的内容：选中，d
25. 向后删除一个字符：x
26. 向前删除一个字符：X
27. 向后删除一个单词：dw (diw，保留待删除的单词后面的空格)
28. 向前删除一个单词：db
29. 删除光标到行首之间的内容：d^
30. 删除光标到行尾部之间的内容: d$
31. 删除当前行：dd
...
34. 撤销上一步：u
35. 恢复上一步撤销：C-r
36. fx:向后查找，最近的一个x字符，并移动光标到x的前面
37. Fz:向前查找，最近的一个z字符,并移动光标到z的前面
38. /:查找，n查找下一个
