...
** DONE [#D] theme:GNU Make中文手册阅读笔记					   :@Blog:@Linux:
	- State "DONE"       from "TODO"       [2017-09-04 一 22:40]
>> Linux下面的可执行文件的ELF格式
...
** DONE [#D] theme:linux-kernel 的makefile架构解析			   :@Blog:@Linux:
	- State "DONE"       from "TODO"       [2017-09-04 一 22:40]
*** 基本架构：
...
顶层Makefile文件根据内核配置，通过递归编译内核代码树子目录建立这两个文件。顶层Makefile文件文本一个名为 arch/$(ARCH)/Makefile的机器体系Makefile文件。机器体系Makefile文件为顶层Makefile文件提供与机器相关的信息。
...
** DONE [#D] theme:开启ftp服务								   :@Blog:@Linux:
	- State "DONE"       from "TODO"       [2017-09-05 二 09:29]
